...
const sttaddr = "0xbd906bb2b8627aa4759cce5bf048b1918693b2eb";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xbd906bb2b8627aa4759cce5bf048b1918693b2eb";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://ironore.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0xbd906bb2b8627aa4759cce5bf048b1918693b2eb',
                    'symbol': 'APPL',
                    'decimals': '18',
                    'image': 'https://ironore.finance/images/logo.png',
                },
            },
